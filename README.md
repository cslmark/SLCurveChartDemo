...
* 显示左侧Y轴以及Y轴网格
![image](SLCurveChartDemo/CurveShowPics/WX20170614-171819@2x.png
)
* 不显示任何坐标轴以及对应的网格 
![image](SLCurveChartDemo/CurveShowPics/WX20170614-172019@2x.png
)
* 显示X轴和对应的网格
![image](SLCurveChartDemo/CurveShowPics/WX20170614-172152@2x.png
)
* 显示正常的左测Y轴和X轴和对应的网格
![image](SLCurveChartDemo/CurveShowPics/WX20170614-172343@2x.png
)
* 同时显示X轴，左右两侧的Y轴以及对应的网格
![image](SLCurveChartDemo/CurveShowPics/WX20170614-172500@2x.png
)
